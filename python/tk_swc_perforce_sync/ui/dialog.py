...
" }")
        ...
        self.entity_breadcrumbs.setObjectName("entity_breadcrumbs")
        # self.entity_breadcrumbs.setStyleSheet("font-size: 9pt;")
        self.horizontalLayout_8.addWidget(self.entity_breadcrumbs)
        ...
        # Sync progress widgets (left-aligned)
        ...
        self.sync_status_label = QLabel(self.middle_area_widget)
        self.sync_status_label.setObjectName("sync_status_label")
        self.sync_status_label.setStyleSheet("color: #2C93E2;")
        self.sync_status_label.setVisible(False)

        self.cancel_sync = QToolButton(self.middle_area_widget)
        self.cancel_sync.setMinimumSize(QSize(60, 20))
        self.cancel_sync.setMaximumSize(QSize(60, 20))
        self.cancel_sync.setObjectName("cancel_sync")
        self.cancel_sync.setVisible(False)
        ...
        # Show sub-items toggle button (right-aligned, before magnifier)
        self.show_sub_items = QToolButton(self.middle_area_widget)
        self.show_sub_items.setObjectName("show_sub_items")
        self.show_sub_items.setCheckable(True)
        self.show_sub_items.setFixedSize(QSize(26, 26))
        icon_folder = QIcon()
        icon_folder.addPixmap(QPixmap(":/res/icon_Folder.png"), QIcon.Normal, QIcon.Off)
        self.show_sub_items.setIcon(icon_folder)
        self.show_sub_items.setIconSize(QSize(18, 18))
        self.show_sub_items.setStyleSheet(
            "QToolButton:checked { background-color: #2C93E2; border: 1px solid #2C93E2; border-radius: 3px; }"
        )

        # Layout order: progress, cancel, status, buttons, spacer, sub-items toggle, magnifier
        self.horizontalLayout_4.addWidget(self.progress)
        self.horizontalLayout_4.addWidget(self.cancel_sync)
        self.horizontalLayout_4.addWidget(self.sync_status_label)
...
"")
        ...
        Dialog.setTabOrder(self.sync_parents, self.submit_files)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QApplication.translate("Dialog", "Load items into your scene", None))
        self.navigation_home.setToolTip(QApplication.translate("Dialog", "Clicking the <i>home button</i> will take you to the location that best matches your current work area.", None))
        self.navigation_home.setAccessibleName(QApplication.translate("Dialog", "navigation_home", None))
        self.navigation_prev.setToolTip(QApplication.translate("Dialog", "<i>Go back</i> in the folder file_history.", None))
        self.navigation_prev.setAccessibleName(QApplication.translate("Dialog", "navigation_prev", None))
        self.navigation_next.setToolTip(QApplication.translate("Dialog", "<i>Go forward</i> in the folder file_history.", None))
        self.navigation_next.setAccessibleName(QApplication.translate("Dialog", "navigation_next", None))

        self.refresh_button.setToolTip(QApplication.translate("Dialog", "Refresh", None))
        self.refresh_button.setAccessibleName(QApplication.translate("Dialog", "refresh_button", None))
        self.get_latest_button.setToolTip(QApplication.translate("Dialog", "Get Latest", None))
        self.get_latest_button.setAccessibleName(QApplication.translate("Dialog", "get_latest_button", None))
        self.submit_button.setToolTip(QApplication.translate("Dialog", "Submit", None))
        self.submit_button.setAccessibleName(QApplication.translate("Dialog", "submit_button", None))

        self.entity_preset_tabs.setToolTip(QApplication.translate("Dialog", "This area shows <i>ShotGrid objects</i> such as Shots or Assets, grouped into sections. ", None))
        self.entity_preset_tabs.setAccessibleName(QApplication.translate("Dialog", "entity_preset_tabs", None))
        self.label_4.setText(QApplication.translate("Dialog", "<small>Filter by Published File Type</small>", None))
        self.publish_type_list.setToolTip(QApplication.translate("Dialog", "This list shows all the relevant <i>publish types</i> for your current selection. By ticking and unticking items in this list, publishes in the main view will be shown or hidden. You can see a summary count next to each publish type, showing how many items of that sort are matching your current selection.", None))
        self.publish_type_list.setAccessibleName(QApplication.translate("Dialog", "publish_type_list", None))
        self.check_all.setText(QApplication.translate("Dialog", "Select All", None))
        self.check_none.setText(QApplication.translate("Dialog", "Select None", None))
        self.sync_files.setText(QApplication.translate("Dialog", "Sync Files", None))
        self.sync_parents.setText(QApplication.translate("Dialog", "Sync Parents", None))
        self.submit_files.setText(QApplication.translate("Dialog", "Submit Files", None))
        self.cancel_sync.setText(QApplication.translate("Dialog", "Cancel", None))
        self.submit_files.setToolTip(QApplication.translate("Dialog", "Submit checked files in the Pending view to the Shotgrid Publisher.", None))
        self.cog_button.setToolTip(QApplication.translate("Dialog", "Tools and Settings", None))
        self.cog_button.setAccessibleName(QApplication.translate("Dialog", "cog_button", None))
        self.entity_breadcrumbs.setToolTip(QApplication.translate("Dialog", "This <i>breadcrumbs listing</i> shows your currently selected ShotGrid location.", None))
        self.thumbnail_mode.setToolTip(QApplication.translate("Dialog", "Thumbnail Mode", None))
        self.thumbnail_mode.setAccessibleName(QApplication.translate("Dialog", "thumbnail_mode", None))
        self.thumbnail_mode.setText(QApplication.translate("Dialog", "...", None))
        self.list_mode.setToolTip(QApplication.translate("Dialog", "List Mode", None))
        self.list_mode.setAccessibleName(QApplication.translate("Dialog", "list_mode", None))
        self.list_mode.setText(QApplication.translate("Dialog", "...", None))
        self.column_mode.setToolTip(QApplication.translate("Dialog", "Column Mode", None))
        self.column_mode.setAccessibleName(QApplication.translate("Dialog", "column_mode", None))
        self.column_mode.setText(QApplication.translate("Dialog", "...", None))
        self.pending_mode.setToolTip(QApplication.translate("Dialog", "Pending Mode", None))
        self.pending_mode.setAccessibleName(QApplication.translate("Dialog", "pending_mode", None))
        self.pending_mode.setText(QApplication.translate("Dialog", "...", None))
        self.submitted_mode.setToolTip(QApplication.translate("Dialog", "Submitted Mode", None))
        self.submitted_mode.setAccessibleName(QApplication.translate("Dialog", "submitted_mode", None))
        self.submitted_mode.setText(QApplication.translate("Dialog", "...", None))
        self.search_publishes.setToolTip(QApplication.translate("Dialog", "Filter Publishes", None))
        self.search_publishes.setAccessibleName(QApplication.translate("Dialog", "search_publishes", None))
        self.info.setToolTip(QApplication.translate("Dialog", "Use this button to <i>toggle details on and off</i>. ", None))
        self.info.setText(QApplication.translate("Dialog", "Show Details", None))
        self.publish_view.setAccessibleName(QApplication.translate("Dialog", "publish_view", None))
        self.show_sub_items.setToolTip(QApplication.translate("Dialog", "Show items in subfolders", None))
        self.show_sub_items.setAccessibleName(QApplication.translate("Dialog", "show_sub_items", None))
        self.thumb_scale.setToolTip(QApplication.translate("Dialog", "Use this handle to <i>adjust the size</i> of the displayed thumbnails.", None))
        self.thumb_scale.setAccessibleName(QApplication.translate("Dialog", "thumb_scale", None))
        self.file_details_image.setAccessibleName(QApplication.translate("Dialog", "file_details_image", None))
        self.file_details_image.setText(QApplication.translate("Dialog", "TextLabel", None))
        self.file_detail_playback_btn.setToolTip(QApplication.translate("Dialog", "The most recent published version has some playable media associated. Click this button to launch the ShotGrid <b>Media Center</b> web player to see the review version and any notes and comments that have been submitted.", None))
        self.file_detail_actions_btn.setText(QApplication.translate("Dialog", "Actions", None))
        self.version_file_history_label.setText(QApplication.translate("Dialog", "<small>Complete Version File History</small>", None))
        self.file_history_view.setAccessibleName(QApplication.translate("Dialog", "file_history_view", None))
